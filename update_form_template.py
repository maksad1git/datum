...
try:
    ...
    print(f"Found form template: {form_template.name}")
except FormTemplate.DoesNotExist:
    print("ERROR: FONON form template not found!")
    sys.exit(1)

# Get all coefficient IDs for linking
coefficients = {coef.code: coef.id for coef in Coefficient.objects.all()}
...
print(f"SUCCESS! Updated form template with {len(fields_schema)} fields")
print("\nField sections:")
sections = {}
...
print(f"  {linked_count} fields linked to coefficients")
